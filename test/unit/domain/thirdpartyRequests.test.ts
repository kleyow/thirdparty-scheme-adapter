...
describe('thirdpartyRequests/transactions', (): void => {
  ...
  it('buildPayeeQuoteRequestFromTpaRequest should construct a proper quote request', (): void => {
  ...
  it('forwardPostQuoteRequestToPayee transform a TPR into a Quote request and forward it to a payee', (): void => {
